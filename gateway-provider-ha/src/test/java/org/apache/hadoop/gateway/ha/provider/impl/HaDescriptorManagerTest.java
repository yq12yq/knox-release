...
public class HaDescriptorManagerTest {
   ...
   public void testDescriptorStoring() throws IOException {
      ...
      String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
            ...
            "</ha>\n";
      assertThat( the( xml ), hasXPath( "/ha/service[@enabled='false' and @failoverSleep='1000' and @maxFailoverAttempts='42' and @maxRetryAttempts='3' and @name='foo' and @retrySleep='3000']" ) );
