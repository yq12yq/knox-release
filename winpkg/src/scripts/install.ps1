...
###
### Install script that can be used to install knox as a Single-Node cluster.
...
###   knox services as Windows services.
...
try
{
    ...
    $utilsModule = Import-Module -Name "$scriptDir\..\resources\Winpkg.Utils.psm1" -ArgumentList ("knox") -PassThru
